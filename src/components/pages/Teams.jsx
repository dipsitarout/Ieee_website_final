...
export const AnimatedTestimonials = ({ testimonials, autoplay = false }) => {
    ...
    return (
        <div className="w-full bg-black text-white"> {/* Full-width black background */}
                ...
                <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-between py-4">
                        ...
                        >
                            ...
                            {testimonials[active].linkedin && (
                                <a 
                                    ...
                                    className="mt-6 inline-flex items-center gap-2 text-gray-300 hover:text-white transition"
                                >
                                    <Linkedin size={24} />
                        ...
                        <div className="flex gap-4 pt-12 md:pt-0">
                            <button
                                onClick={handlePrev}
                                className="group/button flex h-7 w-7 items-center justify-center rounded-full bg-gray-700 hover:bg-gray-600"
                            >
